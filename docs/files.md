...
| File | Description |
|------|-------------|
| **app.py** | Streamlit web dashboard. Run with `streamlit run app.py`. Lets you browse synthetic/real-world data, run benchmarks, view comparison images and reports, and delete generated data. |
